local localizations = {
	...
	show_warning_crosshair_description = {
		en = "On game start, check if user has Crosshair Remap but EWC is deactivating crosshairs when aiming down sights. Warns user if so.",
	},
	show_warning_laser = {
		en = "Laser Warning",
	},
	show_warning_laser_description = {
		en = "On game start, check if EWC is deactivating lasers when aiming down sights. Warns user if so.",
	},
	warning_remap = {
		en = "You do not have Crosshair Remap installed/enabled! Without it, aiming with hidden viewmodels will NOT have a crosshair. If you're ok with that and don't want to see this warning, disable this warning by toggling 'Crosshair Remap Warning' in this mod's settings. Alternatively, type '/ack_remap' in game chat."
	},
	warning_crosshair = {
